...
export default function FlightDetails({ route={} }) {
    ...
    return (
        <SafeAreaView style={{ flex: 1 }} testID="flight-details">
            <View style={styles.flightContainer}>
                <View style={styles.flightSubContainer}>
                    <View style={styles.airlineNameContainer}>
                        <Text style={styles.alirlineName} testID='flight-details-airlineName'>
                ...
                <View style={[styles.flightSubContainer]}>
                    <View >
                        ...
                        <Text style={styles.cityCode} testID='source-city-code'>
                    ...
                    <View >
                        ...
                        <Text style={[styles.cityCode, { textAlign: 'right' }]} testID='destination-city-code'>
                            {flight?.displayData?.destination?.airport?.cityCode}
                        </Text>
                    </View>
                </View>
                <View style={styles.airportnameContainer}>
                    <Text style={styles.airportNameText} testID='source-airport-name'>
                        {flight?.displayData?.source?.airport?.airportName}
                    </Text>
                    <Text style={[styles.airportNameText, { textAlign: 'right' }]} testID='destination-airport-name'>
                ...
                <View style={styles.fareContainer}>
                    ...
                    <View>
                        <Image style={{ width: 20, height: 20 }} source={Rupees} />
                        <Text style={styles.flightfarePriceText} testID='fare-details'>
                            {flight?.fare}
                        </Text> 
                    </View> 
                </View>
                <View>
                    <Pressable style={styles.searchButton} onPress={() => null}>
                        <Text style={styles.searchText}>Confirm Booking</Text>
                    </Pressable>
                </View>
            </View>
        </SafeAreaView>
